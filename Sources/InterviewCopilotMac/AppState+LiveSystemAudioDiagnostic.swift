...
extension AppState {
    ...
    nonisolated private static let liveSystemAudioDiagnosticNotification = Notification.Name("com.langcheng.InterviewCopilotMac.LiveSystemAudioFinalDiagnostic")
