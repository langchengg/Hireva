...
final class AppState: ObservableObject {
    ...
    private func generateSuggestion(
        ...
        if autoGenerated {
            ...
            lastAutoQuestionText = normalizedQuestion(question.questionText)
        }
        updateDiagnostics {
    ...
    private func isDuplicateAutoQuestion(_ questionText: String) -> Bool {
        ...
        guard !normalized.isEmpty, let lastAutoQuestionText else { return false }
        return normalized == lastAutoQuestionText || normalized.contains(lastAutoQuestionText) || lastAutoQuestionText.contains(normalized)
    }
