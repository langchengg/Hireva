    ...
    private var currentGenerationTab: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            card("Current QA Binding", icon: "link") {
                ...
                diagnosticRow("speakerRole", appState.lastSpeakerRole)
                ...
                diagnosticRow("interviewPhase", appState.interviewPhase.rawValue)
                diagnosticRow("interviewContextMode", appState.interviewContextMode.rawValue)
                diagnosticRow("interviewListeningMode", appState.interviewListeningMode.rawValue)
                diagnosticRow("candidatePresentationMode", appState.candidatePresentationMode.rawValue)
                diagnosticRow("candidateAsksPanelMode", appState.candidateAsksPanelMode.rawValue)
