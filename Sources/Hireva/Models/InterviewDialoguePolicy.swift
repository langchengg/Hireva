...
enum DialogueSettingsStore {
    static let contextModeKey = HirevaPreferenceKeys.interviewContextMode
    static let sessionModeKey = HirevaPreferenceKeys.interviewSessionMode
    static let answerPanelQuestionsKey = HirevaPreferenceKeys.answerPanelQuestions
    static let suppressPresentationKey = HirevaPreferenceKeys.suppressPresentation
    static let suppressCandidateQuestionsKey = HirevaPreferenceKeys.suppressCandidateQuestions
    static let legacyListeningModeKey = HirevaPreferenceKeys.legacyListeningMode
    static let legacyPhaseKey = HirevaPreferenceKeys.legacyPhase
