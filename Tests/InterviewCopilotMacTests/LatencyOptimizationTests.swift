...
struct LatencyOptimizationTests {
    ...
    func appStateDisplaysFirstKeyPointBeforeStageBStreamEndsAndPersistsLater() async throws {
        ...
        let firstKeyPointDeadline = Date().addingTimeInterval(2.0)
        ...
        let fullCardDeadline = Date().addingTimeInterval(2.0)
        ...
        let persistenceDeadline = Date().addingTimeInterval(2.0)
